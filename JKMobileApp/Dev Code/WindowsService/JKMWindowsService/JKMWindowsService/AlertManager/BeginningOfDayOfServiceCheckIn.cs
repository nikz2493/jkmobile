...
{
    public class BeginningOfDayOfServiceCheckIn : IBeginningOfDayOfServiceCheckIn
    {
        private readonly IAPIHelper apiHelper;
        private readonly IGenericMethods genericMethods;
        private readonly IResourceManagerFactory resourceManager;
        private readonly ILogger logger;
        private readonly AlertJSONGenerator.IBeginningOfDayOfServiceGenerator beginningOfDayOfServiceGenerator;
        ...
        public void SendAlerts()
        {
            ...
            try
            {
                ...
                timeDifferenceInMinutes = DateTime.Parse(ConfigurationManager.AppSettings["StartTimeForBeginOfService"]).Subtract(startTime).TotalMinutes;
